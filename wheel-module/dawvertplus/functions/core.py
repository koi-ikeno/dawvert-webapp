...
from dawvertplus.plugin_input import base as base_input
from dawvertplus.plugin_output import base as base_output
from ..experiments_plugin_input import base as experiments_plugin_input
from dawvertplus.functions import song_compat
from dawvertplus.functions import plug_conv
from dawvertplus.functions_song import convert_r2m
from dawvertplus.functions_song import convert_ri2mi
from dawvertplus.functions_song import convert_ri2r
from dawvertplus.functions_song import convert_rm2r
from dawvertplus.functions_song import convert_m2r
from dawvertplus.functions_song import convert_m2mi
from dawvertplus.functions_song import convert_mi2m
...
class core:
	...
	def parse_input(self, in_file, extra_json): 
		if 'samples_inside' in self.currentplug_input[4]:
			os.makedirs(extra_json['samplefolder'], exist_ok=True)

		self.convproj_j = [self.currentplug_input[0].parse(in_file, extra_json),
					  self.currentplug_input[3], 
					  self.currentplug_input[4]]
	...
	def convert_type_output(self, extra_json): 
		...
		print('[core] convert_type_output:' + typelist[in_type] + ' > ' + typelist[out_type])
		print('[core] convert_type:' + in_type + ' > ' + out_type)
		...
		if in_type == 'ri' and out_type == 'mi': # RegularIndexed > MultipleIndexed
			self.convproj_j[0] = convert_ri2mi.convert(self.convproj_j[0])
		elif in_type == 'ri' and out_type == 'r': # RegularIndexed > Regular
		...
		elif in_type == 'r' and out_type == 'm': # Regular > Multiple
